...
class NotesItem extends React.Component {
	...
	render() {
		const { id, text, colorId, removeNote, changeColor, pinNote, changeText, isPinned, isDark } = this.props;
		...
		return (
			<li className={className}>
				<div className="notes-item-body" style={{ backgroundColor: noteColor }}>
					<textarea
					...
					<NoteBtn type="note-color-change-btn" isDark={isDark} title={'цвет'} noteId={id} colorId={colorId} changeColor={changeColor} />
